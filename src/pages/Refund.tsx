    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-secondary/10 to-background">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        <section className="space-y-8 font-body text-foreground/85 leading-relaxed">
          <div>
            <h2 className="font-display text-2xl font-semibold mb-3">1. Digital Letters ($6.99)</h2>
          ...
          <div>
            <h2 className="font-display text-2xl font-semibold mb-3">2. Reminder Calls</h2>
            <p>Unused reminder call credits can be refunded within 14 days of purchase. Calls that have already been placed (whether successful or not, due to recipient unavailability) are non-refundable, as the telephony cost has already been incurred.</p>
          </div>

          <div>
            <h2 className="font-display text-2xl font-semibold mb-3">3. How to Request a Refund</h2>
            <p>To request a refund, please email <span className="text-primary">engineer1@wish4love.com</span> or use our <Link to="/contact" className="text-primary underline">contact form</Link> within 14 days of your purchase. Include:</p>
          ...
          <div>
            <h2 className="font-display text-2xl font-semibold mb-3">4. Processing Time</h2>
          ...
          <div>
            <h2 className="font-display text-2xl font-semibold mb-3">5. Chargebacks</h2>
          ...
          <div>
            <h2 className="font-display text-2xl font-semibold mb-3">6. Questions</h2>
